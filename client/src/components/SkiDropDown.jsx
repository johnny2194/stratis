...
class SkiDropDown extends React.Component {
  ...
  render() {
    return (
      <div className="mens-drop-down ski-drop-down">
        <div className="menu">
          <div className="board-links">
            ...
            <div className="link-container"> 
              <div className="link-column">
                ...
                <Link to="/products?" className="category-product-link">Skis</Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(SkiDropDown)